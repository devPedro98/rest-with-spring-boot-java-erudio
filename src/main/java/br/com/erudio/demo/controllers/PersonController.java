...
import br.com.erudio.demo.util.MediaType;
...
public class PersonController {
    ...
    @Operation(summary = "Adds a Person",
            description = "Adds a new Person by passing in a JSON, XLM or YML",
            tags = {"People"},
            responses = {
                    @ApiResponse(description = "Success", responseCode = "200",
                            content = @Content(schema = @Schema(implementation = PersonVO.class))),
    ...
    @Operation(summary = "Updates a Person",
            description = "Updates a Person by passing in a JSON, XLM or YML",
            tags = {"People"},
            responses = {
    ...
    @Operation(summary = "Dislabe a specific person by it's id",
            description = "Dislabe a Person",
            tags = {"People"},
            responses = {
                    @ApiResponse(description = "Success", responseCode = "200",
                            content = @Content(schema = @Schema(implementation = PersonVO.class))),
    ...
    @Operation(summary = "Deletes a Person",
            description = "Deletes a Person by passing in a JSON, XLM or YML",
            tags = {"People"},
            responses = {
                    @ApiResponse(description = "No Content", responseCode = "204", content = @Content),
                    @ApiResponse(description = "Bad Request", responseCode = "400", content = @Content),
