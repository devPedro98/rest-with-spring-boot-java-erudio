...
import br.com.erudio.demo.services.BookServices;
...
public class BookController {
    ...
    @Operation(summary = "Adds a Book",
            description = "Adds a new Book by passing in a JSON, XLM or YML",
            tags = {"Books"},
            responses = {
                    @ApiResponse(description = "Success", responseCode = "200",
    ...
    @Operation(summary = "Updates a Book",
            description = "Updates a Book by passing in a JSON, XLM or YML",
            tags = {"Books"},
            responses = {
    ...
    @Operation(summary = "Deletes a Book",
            description = "Deletes a Book by passing in a JSON, XLM or YML",
            tags = {"Books"},
            responses = {
                    @ApiResponse(description = "No Content", responseCode = "204", content = @Content),
                    @ApiResponse(description = "Bad Request", responseCode = "400", content = @Content),
